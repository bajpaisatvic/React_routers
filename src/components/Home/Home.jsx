  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
        ...
        <div className="absolute inset-0  sm:my-10 sm:pt-1 pt-12  ">
          <img
            className="md:w-96 w-48 rounded-md"
            src="https://images.pexels.com/photos/32665587/pexels-photo-32665587.jpeg"
            alt="image1"
          />
        </div>
      </aside>
      ...
      <div className="grid  place-items-center sm:mt-5">
        <img
          ...
          src="https://images.pexels.com/photos/16200703/pexels-photo-16200703.jpeg"
          alt="image2"
        />
      </div>
